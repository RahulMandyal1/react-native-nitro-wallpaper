...
If you want to use Android Studio to edit the native code, you can open the `example/android` directory in Android Studio. To edit the Java or Kotlin files, open `example/android` in Android Studio and find the source files at `react-native-wallpaper-set` under `Android`.
